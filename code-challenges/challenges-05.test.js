...
Write a function called sortStarWarsCharacters that sorts the characters in the starWarsPeople array by 
...
const sortStarWarsCharacters = (starWarsArr) => {
  return starWarsArr.slice(0).sort(function(a,b) {
    return (a[starWarsArr] < b[starWarsArr]) ? 1 : (a[starWarsArr] > b[starWarsArr]) ? -1 : 0;
  });
}
